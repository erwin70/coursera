...
<!DOCTYPE html>
 ...
 <nav> 
 <ul id="menuPc"> 
 <li class="headlink"><a href= "html"title="home">Home</a></li> 
 <li class="headlink">|</li>
 <li class="headlink"><a href="" title="Film's">Films <span class="icon-white">&nbsp;</span></a>
 <ul><div id="submenu">
 ...
 <ul id="menuMob">
 <li class="headlink"><a title="home">Menu <apan clasa="icon-white">&nbsp;</span></a>
 <ul><div id=" supmenu">
<li> xa href = "" title = "home"> Startpagina </a> </li> 
<li> <a href="" title="Film's"> Films </a> </li> 
<li>  <a href="" title="Contact"> Contact </a> x / li>
 </div> </ul>
 </li>
 </ul>
 </nav> 
